...
set "status-right" "#[fg=$onedark_foreground,bg=default,nounderscore,noitalics]#($TMUX_PLUGIN_MANAGER_PATH/tmux-mem-cpu-load/tmux-mem-cpu-load --graph-lines 5 --cpu-mode 1 --interval 2) ${status_widgets}#[fg=$onedark_white, bg=default]#[fg=$onedark_green,bg=default,nobold,nounderscore,noitalics]#[fg=$onedark_background,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
