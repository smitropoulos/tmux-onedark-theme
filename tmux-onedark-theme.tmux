...
set "status-right" "#[fg=$onedark_foreground,bg=$onedark_background,nounderscore,noitalics]#($TMUX_PLUGIN_MANAGER_PATH/tmux-mem-cpu-load/tmux-mem-cpu-load --mem-mode 2 -g 5 --interval 2)  #[fg=$onedark_foreground,bg=$onedark_background,nounderscore,noitalics]${time_format}  ${date_format}  ${status_widgets}#[fg=$onedark_visual_grey,bg=$onedark_background]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey] #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_background,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
